            ...
            // Requisição da primeira carta
                ...
                // Requisição da Segunda carta
                    ...
                    printf("Super Poder Carta 2: %.2f \n", superpoder2);
                        ...
                        printf("\nQual será o atributo comparado?\n");
                        printf("1. População.\n");
                        printf("2. Área.\n");
                        printf("3. PIB.\n");
                        ...
                        case 1:
                            ...
                            printf("### Resultado: %s ###\n", 
                            (populacao1 > populacao2) ? "Carta 1 - (São Paulo) venceu!" :
                            (populacao1 < populacao2) ? "Carta 2 - (Rio de Janeiro) venceu!" : "Empate!");
                        ...
                        case 2:
                            ...
                            printf("### Resultado: %s ###\n",
                            (area1 > area2) ? "Carta 1 - (São Paulo) venceu!" :
                            (area1 < area2) ? "Carta 2 - (Rio de Janeiro) venceu!" : "Empate!");
                        break;
                        ...
                        case 3:
                            ...
                            printf("Carta 2 - Rio de Janeiro (RJ): %.2f\n", pib2);
                            printf("### Resultado: %s ###\n",
                            (pib1 > pib2) ? "Carta 1 - (São Paulo) venceu!" :
                            (pib1 < pib2) ? "Carta 2 - (Rio de Janeiro) venceu!" : "Empate!");
                        break;
                        ...
                        case 4:
                            ...
                            printf("### Resultado: %s ###\n", 
                            (turistico1 > turistico2) ? "Carta 1 - (São Paulo) venceu!" :
                            (turistico1 < turistico2) ? "Carta 2 - (Rio de Janeiro) venceu!" : "Empate!");
                        break;
                        ...
                        case 5:
                            ...
                            printf("Carta 2 - Rio de Janeiro (RJ): %.2f\n", densidade2);
                            printf("### Resultado: %s ###\n",
                            (densidade1 < densidade2) ? "Carta 1 - (São Paulo) venceu!" :
                            (densidade1 > densidade2) ? "Carta 2 - (Rio de Janeiro) venceu!" : "Empate!");      
                        break;
